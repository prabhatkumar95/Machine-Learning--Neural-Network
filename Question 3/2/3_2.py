...
for alp in alphaList:
    nn_obj = MLPClassifier(random_state=1, hidden_layer_sizes=(500, 400, 300, 200, 100, 50), activation='relu',
...
nn_obj = MLPClassifier(random_state=1, hidden_layer_sizes = (500, 400, 300, 200, 100, 50), activation='relu', early_stopping=True, verbose=True, alpha=alp, solver='adam')
nn_obj.fit(train_X, train_Y)
pyplot.xlabel('epoch')
